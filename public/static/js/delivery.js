    ...
    Delivery.prototype = {
        ...
        appendRulesTr: function (regionStr, checkedIds) {
            var $html = $(
                ...
                '</td>' +
                '<td>' +
                '   <input type="number" class="layui-input" name="delivery[rule][first][]" value="1" datatype="*">' +
                '</td>' +
                '<td>' +
                '   <input type="number" class="layui-input" name="delivery[rule][first_fee][]" value="0.00"  datatype="*">' +
                '</td>' +
                '<td>' +
                '   <input type="number" class="layui-input" name="delivery[rule][additional][]" value="0">' +
                '</td>' +
                '<td>' +
                '   <input type="number" class="layui-input" name="delivery[rule][additional_fee][]" value="0.00">' +
                '</td>' +
                '</tr>'
            );
