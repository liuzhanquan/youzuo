...
function picker_show(){
    ...
    $.each($('.draggable label'),function(index){
        if( $(this).attr('type') == 'picker' && picker ){
            $('#picker').css('display','none');
            picker = 0
        }
        
        if( $(this).attr('type') == 'textarea' && textarea ){
...
//表单自定义
function tableList(id, name="", title="", placeholder=[],must = false , datacate = 0, type = 0 , cid = 0 ) {
    var content = "";
    var str = ''
    var mustStr = '';
    if( must ){
    ...
    switch (id) {
        case "text":
            ...
            var text = '<input type="text" class="form-control" placeholder="'+placeholder+'">';
            content = '<div class="form-group draggable ui-draggable dropped"><label class="col-sm-2 control-label" type="text" name="'+name+'">'+title+'</label><div class="col-sm-7">' + text + '</div><p class="tools col-sm-3"><a class="edit-link" name="text" title="设置"><i class="fa layui-icon layui-icon-set-fill"></i></a><a class="remove-link"><i class="fa layui-icon layui-icon-delete"></i></a><label class="labcheck"><input type="checkbox" datacate="'+datacate+'" types="'+type+'" cid="'+cid+'" '+ mustStr +'> 必填</label></p></div>';
            break;
        case "select":
            //下拉框
            if( title == '' ){
            ...
            if( placeholder.length ){
                ...
                for(var i in placeholder){
                    str = str + '<option>'+placeholder[i]+'</option>'
                }

            }else{
                str = '<option>请选择</option><option>默认</option>'
            }
            var select = '<select class="form-control">'+ str +'</select>';
            content = '<div class="form-group draggable ui-draggable dropped"><label class="col-sm-2 control-label" type="select" name="'+name+'">'+title+'</label><div class="col-sm-7">' + select + '</div><p class="tools col-sm-3"><a class="remove-link"><i class="fa layui-icon layui-icon-delete"></i></a><label class="labcheck"><input type="checkbox" datacate="'+datacate+'" types="'+type+'" cid="'+cid+'" '+ mustStr +'> 必填</label></p></div>';
            break;
        case "textarea":
            //多行文本
            if( title == '' ){
            ...
            var textarea = '<textarea class="form-control" placeholder="'+str+'"></textarea>';
            content = '<div class="form-group draggable ui-draggable dropped"><label class="col-sm-2 control-label" type="textarea" name="'+name+'">'+title+'</label><div class="col-sm-7">' + textarea + '</div><p class="tools col-sm-3"><a class="edit-link" name="textarea" title="设置"> <i class="fa layui-icon layui-icon-set-fill"></i></a><a class="remove-link"><i class="fa layui-icon layui-icon-delete"></i></a><label class="labcheck"><input type="checkbox" datacate="'+datacate+'" types="'+type+'" cid="'+cid+'" '+ mustStr +'> 必填</label></p></div>';
            break;
        case "radio":
            //单选框
            ...
            if( placeholder.length ){
                ...
                for(var i in placeholder){
                    if( i == 0 ){
                        str = str + '<label class="radio-inline"><input type="radio" value="'+placeholder[i]+'" name="rad' + radom + '" checked> '+placeholder[i]+'</label>'
                    }else{
                        str = str + '<label class="radio-inline"><input type="radio" value="'+placeholder[i]+'" name="rad' + radom + '"> '+placeholder[i]+'</label>'
                    }
                }

            }else{
                str = '<label class="radio-inline"><input type="radio" value="默认1" name="rad' + radom + '" checked> 默认1</label><label class="radio-inline"><input type="radio" name="rad' + radom + '" value="默认2"> 默认2</label>'
            }
            var radio = str;
            content = '<div class="form-group draggable ui-draggable dropped"><label class="col-sm-2 control-label" type="radio" name="'+name+'">'+title+'</label><div class="col-sm-7">' + radio + '</div><p class="tools col-sm-3"><a class="remove-link"><i class="fa layui-icon layui-icon-delete"></i></a><label class="labcheck"><input type="checkbox" datacate="'+datacate+'" types="'+type+'" cid="'+cid+'" '+ mustStr +'> 必填</label></p></div>';
            break;
        case "checkbox":
            //多选框
            if( title == '' ){
            ...
            if( placeholder.length ){
                ...
                for(var i in placeholder){
                    str = str + '<label class="radio-inline" style="padding-left:0px;"><input type="checkbox" name="'+placeholder[i]+'"> '+placeholder[i]+'</label>'
                }

            }else{
                str = '<label class="radio-inline" style="padding-left:0px;"><input type="checkbox" name="默认1"> 默认1</label><label class="radio-inline" style="padding-left:0px;"><input type="checkbox" name="默认2"> 默认2</label>'
            }
            var checkbox = str;
            content = '<div class="form-group draggable ui-draggable dropped"><label class="col-sm-2 control-label" type="checkbox" name="'+name+'">'+title+'</label><div class="col-sm-7">' + checkbox + '</div><p class="tools col-sm-3"><a class="remove-link"><i class="fa layui-icon layui-icon-delete"></i></a><label class="labcheck"><input type="checkbox" datacate="'+datacate+'" types="'+type+'" cid="'+cid+'" '+ mustStr +'> 必填</label></p></div>';
            break;
        case "datetime":
            //时间
            if( title == '' ){
            ...
            content = '<div class="form-group draggable ui-draggable dropped"><label class="col-sm-2 control-label" type="datetime" name="'+name+'">'+title+'</label><div class="col-sm-7">' + datetime + '</div><p class="tools col-sm-3"><a class="edit-link" name="datetime" title="设置"> <i class="fa layui-icon layui-icon-set-fill"></i></a><a class="remove-link"><i class="fa layui-icon layui-icon-delete"></i></a><label class="labcheck"><input type="checkbox" datacate="'+datacate+'" types="'+type+'" cid="'+cid+'" '+ mustStr +'> 必填</label></p></div>';
            break;
        case "file":
            //上传
            if( title == '' ){
            ...
            content = '<div class="form-group draggable ui-draggable dropped"><label class="col-sm-2 control-label" type="file" name="'+name+'">'+title+'</label><div class="col-sm-7">' + file + '</div><p class="tools col-sm-3"><a class="edit-link" name="file" title="设置"> <i class="fa layui-icon layui-icon-set-fill"></i></a><a class="remove-link"><i class="fa layui-icon layui-icon-delete"></i></a><label class="labcheck"><input type="checkbox" datacate="'+datacate+'" types="'+type+'" cid="'+cid+'" '+ mustStr +'> 必填</label></p></div>';
            break;
        case "picker":
            //省市区
            if( title == '' ){
            ...
            content = '<div class="form-group draggable ui-draggable dropped"><label class="col-sm-2 control-label" type="picker" name="'+name+'">'+title+'</label><div class="col-sm-7">' + picker + '</div><p class="tools col-sm-3"><a class="edit-link" name="picker" title="设置"> <i class="fa layui-icon layui-icon-set-fill"></i></a><a class="remove-link"><i class="fa layui-icon layui-icon-delete"></i></a><label class="labcheck"><input type="checkbox" datacate="'+datacate+'" types="'+type+'" cid="'+cid+'" '+ mustStr +'> 必填</label></p></div>';
            break;
        case "name":
            //姓名
            var text = '<input type="text" class="form-control" placeholder="请输入你的姓名">';
            content = '<div class="form-group draggable ui-draggable dropped"><label class="col-sm-2 control-label">姓名：</label><div class="col-sm-7">' + text + '</div><p class="tools col-sm-3"><a class="edit-link" name="text" title="设置"> <i class="fa layui-icon layui-icon-set-fill"></i></a><a class="remove-link"><i class="fa layui-icon layui-icon-delete"></i></a><label class="labcheck"><input type="checkbox"> 必填</label></p></div>';
            break;
        case "phone":
            //电话
        ...
        case "www":
            ...
            var text = '<input type="text" class="form-control" placeholder="'+placeholder+'">';
            content = '<div class="form-group draggable ui-draggable dropped"><label class="col-sm-2 control-label" type="www" name="'+name+'">'+title+'</label><div class="col-sm-7">' + text + '</div><p class="tools col-sm-3"><a class="edit-link" name="text" title="设置"> <i class="fa layui-icon layui-icon-set-fill"></i></a><a class="remove-link"><i class="fa layui-icon layui-icon-delete"></i></a><label class="labcheck"><input type="checkbox" datacate="'+datacate+'" types="'+type+'" cid="'+cid+'" '+ mustStr +'> 必填</label></p></div>';
            break;
        case "logo":
            //姓名
            var file = '<input class="file uploadfile" type="file" multiple data-min-file-count="1">';
            content = '<div class="form-group draggable ui-draggable dropped"><label class="col-sm-2 control-label">上传Logo：</label><div class="col-sm-7">' + file + '</div><p class="tools col-sm-3"><a class="edit-link" name="file" title="设置"> <i class="fa layui-icon layui-icon-set-fill"></i></a><a class="remove-link"><i class="fa layui-icon layui-icon-delete"></i></a></p></div>';
            break;
        case "sex":
            //性别
            var radom = Math.ceil(Math.random() * 100000);
            ...
            content = '<div class="form-group draggable ui-draggable dropped"><label class="col-sm-2 control-label">性别：</label><div class="col-sm-7">' + radio + '</div><p class="tools col-sm-3"><a class="edit-link" name="radio" title="设置"> <i class="fa layui-icon layui-icon-set-fill"></i></a><a class="remove-link"><i class="fa layui-icon layui-icon-delete"></i></a></p></div>';
            break;
        case "occupation":
            //职位
