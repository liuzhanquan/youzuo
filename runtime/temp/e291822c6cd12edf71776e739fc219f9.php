<?php /*a:3:{s:67:"D:\phpstudy\WWW\youzuo\application\backman\view\goods\category.html";i:1575886521;s:59:"D:\phpstudy\WWW\youzuo\application\backman\view\layout.html";i:1566201690;s:56:"D:\phpstudy\WWW\youzuo\application\backman\view\nav.html";i:1563374948;}*/ ?>
<!DOCTYPE html>
<html class="admin-sm">
<head>
<meta charset="utf-8">
...
<div class="layui-card-body" data-model="table-bind">
	<blockquote class="layui-elem-quote layui-quote-nm">注：产品分类最多添加2级</blockquote>
	    ...
	    <tbody>
	    	...
	    	<tr>
	    		...
	    		<td><center>
					...
					<?php if($vo['id'] != '51'): ?>
	    			<a class="layui-btn layui-btn-danger layui-btn-xs" data-del data-id="<?php echo htmlentities($vo['id']); ?>" data-table="category">删除</a><?php endif; ?></center>
	    		</td>
	    	</tr>
	    	<?php endforeach; ?>
	    </tbody>
