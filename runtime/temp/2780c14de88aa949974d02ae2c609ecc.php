<?php /*a:3:{s:65:"D:\phpstudy\WWW\youzuo\application\backman\view\goods\option.html";i:1575886658;s:59:"D:\phpstudy\WWW\youzuo\application\backman\view\layout.html";i:1566201690;s:56:"D:\phpstudy\WWW\youzuo\application\backman\view\nav.html";i:1563374948;}*/ ?>
<!DOCTYPE html>
<html class="admin-sm">
<head>
<meta charset="utf-8">
	...
	<form class="layui-form" data-model="form-submit">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" class="layui-input" name="good_sn" value="<?php echo htmlentities($info['good_sn']); ?>">
			</div>
		</div>
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
	    	...
	    	<div class="layui-input-block">
	    		<?php $state = isset($info['status']) ? $info['status'] : '1'; ?>
	      		...
	      		<input type="radio" name="status" value="2" title="下架" <?php if($state == 2): ?> checked="" <?php endif; ?>>
	    	</div>
	  	</div>
		<div class="layui-form-item">
	    	<div class="layui-input-block">
