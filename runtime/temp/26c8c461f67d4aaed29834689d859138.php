<?php /*a:3:{s:60:"/www/web/youzuo/application/backman/view/customer/index.html";i:1583393379;s:52:"/www/web/youzuo/application/backman/view/layout.html";i:1583393382;s:49:"/www/web/youzuo/application/backman/view/nav.html";i:1583393382;}*/ ?>
<!DOCTYPE html>
<html class="admin-sm">
<head>
<meta charset="utf-8">
...
<div class="layui-tab layui-tab-brief">
	<ul class="layui-tab-title">
	    ...
	    <li><a href="<?php echo url('option'); ?>">添加客户</a></li>
  	</ul>
</div>
<div class="demoTable" style="margin-top: 25px;margin-left:20px;">
	客户信息：
	<div class="layui-inline" style="width:250px;">
		<input class="layui-input" name="title" id="title" placeholder="客户编号、名称、负责人、手机号码" autocomplete="off">
	</div>
...
layui.use('table', function(){
	...
	table.render({
		...
		cols: [[
	      	...
	      	,{field:'customer_sn', title: '客户编号', width:80,align:'center'}
	      	,{field:'customer_name', title: '客户名称'}
	      	// ,{field:'price', title: '产品价格'}
	      	,{field:'text', title: '客户分类'}
