<?php /*a:3:{s:60:"/www/web/youzuo/application/backman/view/order/category.html";i:1578884956;s:52:"/www/web/youzuo/application/backman/view/layout.html";i:1577170781;s:49:"/www/web/youzuo/application/backman/view/nav.html";i:1563374948;}*/ ?>
<!DOCTYPE html>
<html class="admin-sm">
<head>
<meta charset="utf-8">
...
<div class="layui-tab layui-tab-brief">
	<ul class="layui-tab-title">
	    <li class="layui-this">检测类型列表</li>
	    <li><a href="<?php echo url('category_op'); ?>">检测类型添加</a></li>
  	</ul>
</div>
	...
	<table class="layui-table" data-table>
		<thead>
	      	<tr>
	        	...
	        	<th>检测类型名称</th>
	        	<th width="150"><center>排序</center></th>
	    ...
	    <tbody>
	    	...
	    	<tr>
	    		...
	    		<td><center>
	    			...
	    			<a class="layui-btn layui-btn-danger layui-btn-xs" data-del data-id="<?php echo htmlentities($vo['id']); ?>" data-table="i_category">删除</a></center>
	    		</td>
	    	</tr>
	    	<?php endforeach; ?>
	    </tbody>
