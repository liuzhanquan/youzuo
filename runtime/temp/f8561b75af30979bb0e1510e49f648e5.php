<?php /*a:3:{s:58:"/www/web/youzuo/application/backman/view/staff/option.html";i:1576932475;s:52:"/www/web/youzuo/application/backman/view/layout.html";i:1577170781;s:49:"/www/web/youzuo/application/backman/view/nav.html";i:1563374948;}*/ ?>
<!DOCTYPE html>
<html class="admin-sm">
<head>
<meta charset="utf-8">
            ...
            <?php if(is_array($power) || $power instanceof \think\Collection || $power instanceof \think\Paginator): if( count($power)==0 ) : echo "" ;else: foreach($power as $key=>$item): ?>
                {
                    ...
                    ,id: "<?php echo htmlentities($item['id']); ?>"
                    <?php if(powerStatus($item['id'],$info['power']) && empty($item['son'])): ?>
                    ,checked: true
                    <?php endif; ?>
                    ,spread: true
                    ,field:'power[]'
                    ,children: [
                        ...
                        {
                            title: '<?php echo htmlentities($i['name']); ?>'
                            ,id: "<?php echo htmlentities($i['id']); ?>"
                            <?php if(powerStatus($i['id'],$info['power'])): ?>
                            ,checked: true
                            <?php endif; ?>
                            ,field:'power[]'
                        },
