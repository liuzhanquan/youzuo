<?php /*a:3:{s:70:"D:\phpstudy\WWW\youzuo\application\backman\view\customer\category.html";i:1575886514;s:59:"D:\phpstudy\WWW\youzuo\application\backman\view\layout.html";i:1566201690;s:56:"D:\phpstudy\WWW\youzuo\application\backman\view\nav.html";i:1563374948;}*/ ?>
<!DOCTYPE html>
<html class="admin-sm">
<head>
<meta charset="utf-8">
...
<div class="layui-tab layui-tab-brief">
	<ul class="layui-tab-title">
	    ...
	    <li><a href="<?php echo url('category_op'); ?>">新增分类</a></li>
  	</ul>
</div>
<div class="layui-card-body" data-model="table-bind">
	<blockquote class="layui-elem-quote layui-quote-nm">注：客户分类最多添加2级</blockquote>
	<table class="layui-table" data-table>
	    ...
	    <tbody>
	    	...
	    	<tr>
	    		...
	    		<td><center>
	    			<a class="layui-btn layui-btn-xs" href="<?php echo url('category_op',['id'=>$vo['id']]); ?>">编辑</a>
					<?php if($vo['id'] != '51'): ?>
	    			<a class="layui-btn layui-btn-danger layui-btn-xs" data-del data-id="<?php echo htmlentities($vo['id']); ?>" data-table="cus_category">删除</a><?php endif; ?></center>
	    		</td>
	    	</tr>
	    	<?php endforeach; ?>
	    </tbody>
