<?php /*a:3:{s:66:"/www/web/codecheck/application/backman/view/customer/category.html";i:1594223536;s:55:"/www/web/codecheck/application/backman/view/layout.html";i:1594223536;s:52:"/www/web/codecheck/application/backman/view/nav.html";i:1594223536;}*/ ?>
<!DOCTYPE html>
<html class="admin-sm">
<head>
<meta charset="utf-8">
	...
	<table class="layui-table" data-table>
		<thead>
	      	<tr>
	        	...
	        	<th width="350"><center>操作</center></th>
	      	</tr> 
	    </thead>
	    <tbody>
	    	...
	    	<tr>
	    		...
	    		<td><center>
					...
					<a class="layui-btn layui-btn-xs" href="<?php echo url('category_op',['id'=>0,'parent_id'=>$vo['id']]); ?>">添加子类</a>
					<?php endif; if($vo['id'] != '51'): ?>
