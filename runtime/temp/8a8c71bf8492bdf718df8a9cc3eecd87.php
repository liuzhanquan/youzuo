<?php /*a:3:{s:61:"/www/web/codecheck/application/backman/view/setting/user.html";i:1594223536;s:55:"/www/web/codecheck/application/backman/view/layout.html";i:1594223536;s:52:"/www/web/codecheck/application/backman/view/nav.html";i:1594223536;}*/ ?>
<!DOCTYPE html>
<html class="admin-sm">
<head>
<meta charset="utf-8">
...
<div class="layui-tab layui-tab-brief">
	<ul class="layui-tab-title">
	    ...
	    <li><a href="<?php echo url('option'); ?>">新增管理员</a></li>
  	</ul>
</div>
...
layui.use('table', function(){
	...
	table.render({
		...
		cellMinWidth: 80,
		cols: [[
	      	{field:'id',width:80, title: '用户ID', sort: true,align:'center'}
	      	,{field:'name', title: '用户名'}
	      	,{field:'group', title: '权限组'}
	      	,{field:'reg', title: '添加时间',width:150}
