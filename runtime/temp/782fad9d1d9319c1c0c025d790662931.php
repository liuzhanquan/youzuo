<?php /*a:3:{s:57:"/www/web/youzuo/application/backman/view/staff/index.html";i:1583393389;s:52:"/www/web/youzuo/application/backman/view/layout.html";i:1583393382;s:49:"/www/web/youzuo/application/backman/view/nav.html";i:1583393382;}*/ ?>
<!DOCTYPE html>
<html class="admin-sm">
<head>
<meta charset="utf-8">
...
<div class="demoTable" style="margin-top: 25px;margin-left:20px;">
	...
	<div class="layui-inline" style="width:250px;">
		<input class="layui-input" name="title" id="title" placeholder="员工编号、姓名、手机号码" autocomplete="off">
	</div>
	<div class="layui-inline">
		<form class="layui-form">
			<select class="layui-input" name="cid" id="cid" lay-filter="cid">
				<option value="">请选择员工分类</option>
...
layui.use(['table','upload'], function(){
	...
	table.render({
		...
		cols: [[
	      	...
	      	,{field:'staff_sn', title: '员工编号', width:180,align:'center'}
	      	,{field:'name',width:130, title: '员工名称'}
	      	// ,{field:'price', title: '产品价格'}
	      	,{field:'text',width:130, title: '分类'}
