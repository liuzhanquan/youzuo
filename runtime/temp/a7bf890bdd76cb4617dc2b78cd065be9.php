<?php /*a:1:{s:59:"/www/web/codecheck/application/backman/view/index/home.html";i:1594223536;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
	            ...
	            <div class="layui-card-body ">
	                <ul class="layui-row layui-col-space10 layui-this x-admin-carousel x-admin-backlog">
	                    ...
	                    <li class="layui-col-md3 layui-col-xs6">
	                        <a href="javascript:;" class="x-admin-backlog-body">
	                            <h3>进行中的检测单</h3>
	                            <p><cite><?php echo htmlentities($info['orderIngCount']); ?></cite></p>
	                        </a>
	                    </li>
	                    <li class="layui-col-md3 layui-col-xs6">
	                        <a href="javascript:;" class="x-admin-backlog-body">
	                            <h3>检测流程总数</h3>
	                            <p><cite><?php echo htmlentities($info['detectionCount']); ?></cite></p>
	                        </a>
	                    </li>
	                    <li class="layui-col-md3 layui-col-xs6">
	                        <a href="javascript:;" class="x-admin-backlog-body">
	                            <h3>客户总数</h3>
	                            <p><cite><?php echo htmlentities($info['customerCount']); ?></cite></p>
	                        </a>
	                    </li>
	                </ul>
	            </div>
    ...
    xAxis : [
        {
            ...
            data : JSON.parse('<?php echo $info['time']; ?>'),
        }
    ],
    yAxis : [
        {
    ...
    series : [
        {
            ...
            areaStyle: {normal: {}},
            // data:[11,22,33]
            data:JSON.parse('<?php echo $info['total']; ?>')
        }
        // {
        //     name:'收入金额',
        //     type:'line',
