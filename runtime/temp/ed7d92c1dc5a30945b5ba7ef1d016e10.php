<?php /*a:3:{s:66:"/www/web/youzuo/application/backman/view/customer/category_op.html";i:1578023066;s:52:"/www/web/youzuo/application/backman/view/layout.html";i:1577170781;s:49:"/www/web/youzuo/application/backman/view/nav.html";i:1563374948;}*/ ?>
<!DOCTYPE html>
<html class="admin-sm">
<head>
<meta charset="utf-8">
			...
			<div class="layui-input-block">
				<select name="parent_id" lay-filter="aihao">
					...
					<?php foreach($group as $vo): ?>
	           		<option value="<?php echo htmlentities($vo['id']); ?>" <?php if($vo['id'] == $info['parent_id']): ?>selected=""<?php endif; if($parent_id == $vo['id']): ?>selected=""<?php endif; ?> ><?php echo htmlentities($vo['name']); ?></option>
	           		<?php endforeach; ?>
				</select>
			</div>
		</div>
		<?php else: ?>
		<input type="hidden" name="parent_id" value="<?php echo htmlentities($info['parent_id']); ?>" />
		<?php endif; ?>
		<!-- <div class="layui-form-item">
