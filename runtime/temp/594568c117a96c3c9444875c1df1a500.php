<?php /*a:3:{s:63:"/www/web/youzuo/application/backman/view/order/category_op.html";i:1578884705;s:52:"/www/web/youzuo/application/backman/view/layout.html";i:1577170781;s:49:"/www/web/youzuo/application/backman/view/nav.html";i:1563374948;}*/ ?>
<!DOCTYPE html>
<html class="admin-sm">
<head>
<meta charset="utf-8">
...
<div class="layui-tab layui-tab-brief">
	<ul class="layui-tab-title">
	    ...
	    <li class="layui-this"><?php if(empty($info) || (($info instanceof \think\Collection || $info instanceof \think\Paginator ) && $info->isEmpty())): ?>新增<?php else: ?>编辑<?php endif; ?>检测类型</li>
  	</ul>
</div>
<div class="layui-card-body">
	<form class="layui-form" data-model="form-submit">
		<div class="layui-form-item">
			<label class="layui-form-label">检测类型名称</label>
			...
			<div class="layui-input-block">
				<select name="parent_id" lay-filter="aihao">
					...
					<?php foreach($group as $vo): ?>
	           		<option value="<?php echo htmlentities($vo['id']); ?>" <?php if($vo['id'] == $info['parent_id']): ?>selected=""<?php endif; ?>><?php echo $vo['cname']; ?></option>
	           		<?php endforeach; ?>
				</select>
			</div>
		</div>
